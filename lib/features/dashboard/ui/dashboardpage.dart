...
import 'package:web3_expense/features/dashboard/bloc/dashboard_bloc.dart';
import 'package:web3_expense/features/dashboard/deposit/deposit.dart';
import 'package:web3_expense/features/dashboard/withdraw/withdraw.dart';
import 'package:web3_expense/utils/colors.dart';
      ...
      body: BlocConsumer<DashboardBloc, DashboardState>(
        ...
        builder: (context, state) {
          switch (state.runtimeType) {
            ...
            case DashboardSucessState:
              final successState = state as DashboardSucessState;
              return Container(
                margin:
